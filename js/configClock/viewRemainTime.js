...
var viewRemainTime = function(){
    this.objRemainTime = new remainTime(2026, 2, 17, 0, 0, 0, 0); // Lấy ra mảng chứa các thành phần time còn lại
    ...
    this.updateChangeRemainTime = function() {
        ...
        var interval = setInterval(()=>{
            ...
            if(this.remainTime != "NEW_YEAR") {
                ...
                let loopCount = 0; // Đếm số lần lặp chữ "Happy New Year 2020"
let textInterval = setInterval(() => {
    switch(this.x){
        // Hiển thị chữ Happy
        case 0:
            this.elementTime = [17, 10, 25, 25, 34, 36, 36, 36, 36];
            ++this.x;
        break;
        // Hiển thị chữ New
        case 1:
            this.elementTime = [23, 14, 32, 36, 36, 36, 36, 36, 36];
            ++this.x;
        break;
        // Hiển thị chữ Year
        case 2:
            this.elementTime = [34, 14, 10, 27, 36, 36, 36, 36, 36];
            ++this.x;
        break;
        // Hiển thị dãy số 2020
        case 3:
            this.elementTime = [2, 0, 2, 6 ,36 ,36, 36, 36, 36];
            this.x = 0;
            loopCount++; // Tăng biến đếm mỗi khi hoàn thành 1 chu kỳ
        break;
    }
    ...
    if(loopCount >= 2){
        ...
        setTimeout(() => {
            window.location.href = "phaohoa.html"; // Chuyển đến trang pháo hoa sau 2 lần lặp
        }, 1500);
    }
